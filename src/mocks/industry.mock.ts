...
const MOCK_REPORT_STATUS = 'PUBLISHED' as PostStatus;

export const mockIndustryAnalyses: IndustryAnalysis[] = [
  {
    industryReportId: 101,
    industryName: '커머스',
    reportStatus: MOCK_REPORT_STATUS,
    reportYear: 2025,
  ...
  },
  {
    ...
    hiring: ['AI 엔지니어 채용 증가', '데이터 사이언티스트 수요 확대', 'MLOps 엔지니어 수요 증가'],
    investment: [
      'AI 스타트업 투자 증가',
      '클라우드 인프라 기업 투자 확대',
      'AI 반도체 분야 투자 활성화',
