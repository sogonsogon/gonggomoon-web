...
interface MyStrategyErrorProps {
  message?: string;
}

export default function MyStrategyError({ message }: MyStrategyErrorProps) {
  return (
    <div className="flex h-90 flex-col items-center justify-center gap-4 rounded-xl border border-gray-200 bg-white">
      ...
      <div className="flex flex-col items-center gap-1.5 text-center">
        <p className="text-[15px] font-semibold text-gray-900">전략을 불러올 수 없어요</p>
